...
import type { TFormValues, TTargetLanguageOption, TLevelOfLanguageOption, TNativeLanguageOption } from "../../../constants/mainForm"
...
> = {
    labelText: string,
    options: readonly TTargetLanguageOption[] | readonly TNativeLanguageOption[] | readonly TLevelOfLanguageOption[],
    id: string,
